...
const Navbar: React.FC<NavbarProps> = ({ onLoginClick, isLoggedIn, onLogout, userName }) => {
  ...
  const handleNavClick = (
    ...
    console.log('CLICK FIRED: navigation_click');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link 
            ...
            onClick={(e) => handleNavClick(e, 'Logo', isLoggedIn ? '/dashboard' : '/')}
          >
                  ...
                  <div className="absolute left-0 mt-0 w-56 bg-white border border-gray-100 rounded-md shadow-lg py-1 animate-in fade-in slide-in-from-top-2 duration-200 z-50">
                    {item.subItems.map((subItem) => (
                      <Link
                        ...
                        onClick={(e) => handleNavClick(e, `${item.label} > ${subItem.label}`, subItem.path)}
                      >
                        {subItem.label}
                      </Link>
                    ))}
          ...
          <div className="hidden lg:flex items-center space-x-4">
             <Button 
              ...
              onClick={() => {
                console.log('CLICK FIRED: promo_click');
                pushToDataLayer('promo_click', { promo_id: 'locate_branch_click' });
              }}
            >
              Locate Branch
            </Button>
