...
const ChatBot: React.FC = () => {
  ...
  const toggleChat = () => {
    ...
    console.log('CLICK FIRED: ' + (newState ? 'chat_open' : 'chat_close'));
    pushToDataLayer(newState ? 'chat_open' : 'chat_close');
  };
  ...
  const handleSend = async (e?: React.FormEvent) => {
    ...
    // GTM Event
    console.log('CLICK FIRED: chat_message_sent');
    pushToDataLayer('chat_message_sent', { message_length: userText.length });
