...
function App() {
  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    ...
    if (loginStep === 1) {
      setLoginStep(2);
      // GTM track step 1
      console.log('CLICK FIRED: login_step_complete');
      pushToDataLayer('login_step_complete', { step: 1, method: 'user_id' });
    } else {
      setIsLoginModalOpen(false);
      setLoginStep(1);
      setIsLoggedIn(true);
      // GTM track login success
      console.log('CLICK FIRED: login_success');
      pushToDataLayer('login_success', { user_id_hash: btoa(userId) });
    }
  };

  const handleLogout = () => {
    console.log('CLICK FIRED: logout');
    setIsLoggedIn(false);
    setUserId('');
      ...
      <div className="flex flex-col min-h-screen font-sans text-gray-900">
        ...
        <Modal 
          ...
          onClose={() => {
            setIsLoginModalOpen(false);
            setLoginStep(1);
            console.log('CLICK FIRED: login_modal_close');
            pushToDataLayer('login_modal_close');
          }}
