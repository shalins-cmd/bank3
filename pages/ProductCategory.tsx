...
const ProductCategory: React.FC<ProductCategoryProps> = ({ title, description, features }) => {
  ...
  const handleApply = () => {
    ...
    pushToDataLayer('application_start', {
      product_name: title,
      category: location.pathname.split('/')[1]
    });
    // delay navigation 100ms to give GTM time to process
    setTimeout(() => {
            ...
            <div className="md:w-1/2 p-8 md:p-12">
              ...
              <div className="flex space-x-4">
                ...
                <Button 
                  ...
                  size="lg"
                  onClick={() => {
                    console.log('CLICK FIRED: download_brochure');
                    pushToDataLayer('download_brochure', {
                      product: title,
                      product_category: location.pathname.split('/')[1]
                    });
                  }}
                >
                  Download Brochure
